...
export default function Home() {
  ...
  const [history, setHistory] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hola! Preguntame cualquier cosas sobre el ToDo Bot de Oracle!",
    },
  ]);
  ...
  return (
    <main className="h-screen bg-white p-2 flex flex-col">
      <div className="flex flex-col gap-2 w-full items-center flex-grow max-h-full">
        ...
        <form
          className="rounded-2xl border-purple-700 border-opacity-5 border lg:w-3/4 flex-grow flex flex-col bg-[url('https://scontent.fgdl1-4.fna.fbcdn.net/v/t1.6435-9/102959664_10158518515936763_7203924000163620674_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=5f2048&_nc_ohc=kQ2BpEeSQ0MQ7kNvgHMhhff&_nc_ht=scontent.fgdl1-4.fna&oh=00_AYCK7L51eq81FzcX60n8RaWUSArX70LsCpAny1cXS8XHNQ&oe=668EEE8A')] bg-cover max-h-full overflow-clip"
          onSubmit={(e) => {
            e.preventDefault();
            handleClick();
          }}
              ...
              switch (message.role) {
                case "assistant":
                  return (
                    ...
                    >
                      <img
                        src="https://logowik.com/content/uploads/images/oracle-corporation9423.jpg"
                      ...
                      <div className="w-auto max-w-xl break-words bg-white rounded-b-xl rounded-tr-xl text-black p-6 shadow-[0_10px_40px_0px_rgba(0,0,0,0.15)]">
                        <p className="text-sm font-medium text-[#C74634] mb-2">
                          Botacle AI
                        </p>
                        {message.content}
                        {message.links && (
